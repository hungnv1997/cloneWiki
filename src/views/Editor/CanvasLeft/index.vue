    ...
    <div class="left-bottom-tabs">
      ...
      >
        ...
        >
          ...
          <div class="left-name">{{ MULTILANG.left_side.title.layer }}</div>
        </div>
      </el-affix>
      <el-affix
        position="bottom"
      ...
      >
        ...
        >
          ...
          <div class="left-name">{{ MULTILANG.left_side.title.help }}</div>
        </div>
      </el-affix>
...
const topTabs: TabItem[] = [
  {
    key: "editor",
    label: MULTILANG.left_side.title.edit,
    icon: `editor`,
    index: 0,
  },
  {
    key: "template",
    label: MULTILANG.left_side.title.template,
    icon: `template`,
    index: 1,
  },
  {
    key: "material",
    label: MULTILANG.left_side.title.material,
    icon: `material`,
    index: 2,
  },
  {
    key: "text",
    label: MULTILANG.left_side.title.text,
    icon: "text",
    index: 3,
  },
  {
    key: "image",
    label: MULTILANG.left_side.title.image,
    icon: "picture",
    index: 4,
  },
  {
    key: "toolkit",
    label: MULTILANG.left_side.title.toolkit,
    icon: "toolkit",
    index: 5,
  },
];
