<template>
  <div class="image-style-panel">
    <div class="title">Code system:</div>
    <el-select
    ...
    <div class="title">Code value:</div>
    <div class="row">
      <el-input
    ...
    <el-row>
      ...
      <el-col :span="11">
        <div class="title">Code height:</div>
        <div class="row">
          <el-input
    ...
    <el-row>
        ...
        <div class="row">
          <el-popover trigger="click" width="265">
            ...
            <ColorPicker
              ...
              @update:modelValue="(value) => updateBackgroundColor(value)"
            />
          </el-popover>
        </div>
      </el-col>
      <el-col :span="2"></el-col>
      <el-col :span="11">
        <div class="title">Barcode color:</div>
        <div class="row">
          <el-popover trigger="click" width="265">
            <template #reference>
              <ColorButton
            ...
            <ColorPicker
              ...
              @update:modelValue="(value) => updateLineColor(value)"
            />
          </el-popover>
        </div>
      </el-col>
