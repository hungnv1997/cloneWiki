  ...
  <div class="element-filter">
    <div class="row">
      ...
      <div class="switch-wrapper" style="flex: 3">
        <el-switch
          v-model="hasFilters"
          @change="toggleFilters(hasFilters)"
        ></el-switch>
      </div>
    </div>
      ...
      <el-row>
        ...
        <el-col :span="11">
          <el-slider
            ...
            :step="0.01"
            v-model="brightness"
            @change="(value) => changeColorMode('Brightness', value)"
          ></el-slider>
        </el-col>
      ...
      <el-row>
        ...
        <el-col :span="11">
          <el-slider
            ...
            :step="0.01"
            v-model="contrast"
            @change="(value) => changeColorMode('Contrast', value)"
          ></el-slider>
        </el-col>
      ...
      <el-row>
        ...
        <el-col :span="11">
          <el-slider
            ...
            :step="0.01"
            v-model="saturation"
            @change="(value) => changeColorMode('Saturation', value)"
          ></el-slider>
        </el-col>
      ...
      <el-row>
        ...
        <el-col :span="11">
          <el-slider
            ...
            :step="0.01"
            v-model="vibrance"
            @change="(value) => changeColorMode('Vibrance', value)"
          ></el-slider>
        </el-col>
      ...
      <el-row>
        ...
        <el-col :span="11">
          <el-slider
            ...
            :step="0.002"
            v-model="hue"
            @change="(value) => changeColorMode('Hue', value)"
          ></el-slider>
        </el-col>
      ...
      <el-row>
        ...
        <el-col :span="11">
          <el-slider
            ...
            :step="100"
            v-model="noise"
            @change="(value) => changeColorMode('Noise', value)"
          ></el-slider>
        </el-col>
      ...
      <el-row>
        ...
        <el-col :span="11">
          <el-slider
            ...
            :step="1"
            v-model="pixelate"
            @change="(value) => changeColorMode('Pixelate', value)"
          ></el-slider>
        </el-col>
      ...
      <el-row>
        ...
        <el-col :span="11">
          <el-slider
            ...
            :step="0.01"
            v-model="blur"
            @change="(value) => changeColorMode('Blur', value)"
          ></el-slider>
        </el-col>
...
const changeGrayScaleMode = (mode: string) => {
  ...
  mode === grayScaleMode.value
    ? (grayScaleMode.value = "")
    : (grayScaleMode.value = mode);
  if (grayScaleMode.value) {
    // @ts-ignore
    handleElement.value.filters.push(
      new filters.Grayscale({ mode: grayScaleMode.value })
    );
...
const changeFilters = () => {
  ...
  if (elementFilters.value.includes("Emboss")) {
    // @ts-ignore
    handleElement.value.filters?.push(
      new filters.Convolute({ matrix: [1, 1, 1, 1, 0.7, -1, -1, -1, -1] })
    );
  }
  handleElement.value.applyFilters();
  canvas.renderAll();
