<template>
  <div class="element-color-mask">
    <div class="row">
      <div style="flex: 1">
        <b>{{ MULTILANG.style.masking }}：</b>
      </div>
      <div class="switch-wrapper" style="flex: 1">
        <el-switch
          v-model="hasColorMask"
          @change="toggleColorMask(hasColorMask)"
        ></el-switch>
      </div>
    </div>
    <template v-if="hasColorMask">
      ...
      <el-row>
        <el-col :span="7" class="slider-name"
          >{{ MULTILANG.style.maskColor }}：</el-col
        >
        ...
        <el-col :span="14">
          <el-popover trigger="click" width="265">
            ...
            <ColorPicker
              ...
              @update:modelValue="(color) => updateMaskColor(color)"
            />
          </el-popover>
        </el-col>
      </el-row>
