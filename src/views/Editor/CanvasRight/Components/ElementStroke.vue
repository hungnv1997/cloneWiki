<template>
  <div class="element-shadow">
    <div class="row">
      <div style="flex: 2"><b>Enable strokes:</b></div>
    ...
    <template v-if="hasStroke">
      <div class="row">
        <div style="flex: 2">Stroke thickness:</div>
        <el-slider
          class="slider"
          v-model="handleStroke.strokeWidth"
        ></el-slider>
      </div>
      <div class="row">
        <div style="flex: 2">Stroke color:</div>
        <el-popover trigger="click" width="265">
          <template #reference>
            <ColorButton :color="handleStroke.stroke" style="flex: 3" />
          </template>
          <ColorPicker
            :modelValue="handleStroke.stroke"
