<template>
  <div class="background-content">
    <div class="row">
      <el-row>
        ...
        <el-col :span="11" v-if="background.fillType === 0">
          <el-popover trigger="click" placement="bottom" :width="265">
            ...
            <ColorPicker
              ...
              @update:modelValue="
                (color) => updateBackground({ color: color, fill: color })
              "
            />
          </el-popover>
        </el-col>
        ...
        <el-col :span="11" v-else-if="background.fillType === 4">
          <el-button class="full-row" @click="generateShadingBackgroundRandom"
            >随机形状</el-button
          >
        </el-col>
      </el-row>
    ...
    <div v-if="background.fillType === 2">
      ...
      <el-row>
        <el-col :span="7" class="slider-name"
          >{{ MULTILANG.style.opacity }}：</el-col
        >
        <el-col :span="13">
          <el-slider
            class="common-slider"
    ...
    <div class="mb-10" v-if="background.fillType === 4">
      ...
      <el-row
        v-if="
          shadingElement.mode === 'stroke-join' ||
          shadingElement.mode === 'stroke'
        "
      >
      ...
      <el-row v-if="shadingElement.maxSpacing[0] > 0">
        ...
        <el-col :span="13">
          <el-slider
            class="common-slider"
            :min="0"
            :max="shadingElement.maxSpacing[0]"
            :step="0.5"
      ...
      <el-row v-if="shadingElement.maxSpacing[1] > 0">
        ...
        <el-col :span="13">
          <el-slider
            class="common-slider"
            :min="0"
            :max="shadingElement.maxSpacing[1]"
            :step="0.5"
        ...
        >
          <el-popover trigger="click" placement="bottom" :width="265">
            ...
            <ColorPicker
              :modelValue="color"
              @update:modelValue="
                (color) => changeShadingIndexColor(index, color)
              "
            />
          </el-popover>
        </div>
...
const { setBackgroudImage, setWorkSpaceImage, getBackgroundImageOption } =
  useHandleBackground();
...
const generateShadingBackgroundRandom = () => {
  const item =
    ShadingColorLibs[Math.floor(getRandomNum(0, ShadingColorLibs.length - 1))];
  shadingElement.value = item;
