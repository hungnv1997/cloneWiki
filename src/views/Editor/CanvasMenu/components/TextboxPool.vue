<template>
  <div class="layout-pool">
    <el-row class="layout-search">
      <el-input
        :prefix-icon="Search"
        :placeholder="MULTILANG.content_thumb.text.search_placeholder"
      ></el-input>
    </el-row>
    <el-row class="layout-text" @click="drawText(80)">
      <div class="large">{{ MULTILANG.content_thumb.text.insert_text }}</div>
    </el-row>
    <el-row class="layout-text" @click="drawText(60)">
      <div class="middle">{{ MULTILANG.content_thumb.text.insert_text }}</div>
    </el-row>
    <el-row class="layout-text" @click="drawText(36)">
      <div class="small">{{ MULTILANG.content_thumb.text.insert_text }}</div>
    </el-row>
    <!-- <el-row class="layout-style">
      <el-col :span="16">
        <el-radio-group class="full-ratio" v-model="textStyle">
          <el-radio-button label="transverse"
            ><IconTextRotationNone />横向</el-radio-button
          >
          <el-radio-button label="direction"
            ><IconTextRotationDown />竖向</el-radio-button
          >
        </el-radio-group>
      </el-col>
      <el-col :span="8">
        <el-checkbox-button v-model="textHollow"
          ><IconText />镂空</el-checkbox-button
        >
      </el-col>
    </el-row>
